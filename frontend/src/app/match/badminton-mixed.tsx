...
export default function BadmintonMixedContent() {
    ...
    const fetchData = async () => {
        try {
            const response = await api.get('api/v1/match/BMX');
    ...
    return (
        <div>
            <p className="text-center text-4xl font-semibold mb-4">แบดมินตันคู่ผสม</p>
            ...
            <Card className="mt-4">
                <CardContent>
                    <Section title="กติกาการแข่งขันแบดมินตันคู่ผสม">
                        <Subsection title="1. ระเบียบและกติกาการแข่งขัน">
                            <RuleItem>
                                การแข่งขันเป็นประเภทคู่ผสม (ชาย-หญิง)
                            </RuleItem>
                        </Subsection>
